...
public class Messages {
  ...
  public static final String COMPANY_UNIVERSITY_PRESENT =
      "Either university or company must be present, but not both.";
  public static final String UPDATE_PROFESSION_WITH_UNIVERSITY =
      "Unable to update profession along with university.";
  ...
  public static final String COMMUNITY_IMAGE_REQUIRED =
      "Community image is required and should be of max size 5MB.";
  public static final String COMMUNITY_DESC_REQUIRED = "Community description is required.";
  public static final String COMMUNITY_NAME_SIZE =
      "Community size must be between 5 to 100 characters.";
  public static final String COMMUNITY_DESC_SIZE =
      "Community description length must be between 10 to 500 characters.";
  public static final String PROFESSION_REQUIRED =
      "Profession must be provided if company is present.";
  public static final String COMPANY_OR_UNIVERSITY_REQUIRED =
      "Either company or university must be provided.";
  public static final String CATEGORY_DESC_REQUIRED = "Category description is required.";
  public static final String CATEGORY_DESC_SIZE =
      "Category desc must be between 10 to 500 characters.";
  public static final String USERNAME_SIZE = "Username must be between 3 to 25 characters.";
  public static final String UNIVERSITY_SIZE =
      "University name must be between 3 to 50 characters.";
  public static final String COMPANY_SIZE = "Company name must be between 3 to 50 characters.";
  public static final String PROFESSION_SIZE =
      "Profession name must be between 3 to 50 characters.";
  public static final String CATEGORY_NAME_SIZE =
      "Category name must be between 3 to 25 characters.";
  ...
  public static final String PLATFORM_DESCRIPTION =
