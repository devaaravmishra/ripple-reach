...
public class Messages {
    ...
    public static final String UNIVERSITY_SIZE = "university name must be between 3 to 30 characters";
    public static final String COMPANY_SIZE = "company name must be between 3 to 30 characters";
    public static final String PROFESSION_SIZE = "profession name must be between 3 to 20 characters";
