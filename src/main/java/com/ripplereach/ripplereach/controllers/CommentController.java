...
@Tag(
    name = "Comment",
    description = "The Comment API. Contains all the operations that can be performed on comments.")
public class CommentController {
  ...
  public static final List<String> ALLOWED_SORT_PROPERTIES =
      Arrays.asList("createdAt", "totalUpvotes");
  ...
  public ResponseEntity<CommentResponse> createComment(
    ...
    CommentResponse comment =
        commentService.createComment(
            commentRequest.getPostId(), commentRequest.getUserId(), commentRequest.getContent());
  ...
  @Operation(
      ...
      parameters =
          @Parameter(
              name = "userId",
              description = "ID of the user to get comments for",
              required = true))
