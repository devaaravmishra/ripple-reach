...
@Tag(
    name = "Upvote",
    description = "The Upvote API. Contains all the operations that can be performed on upvotes.")
@Slf4j
public class UpvoteController {
  ...
  @Operation(
      ...
      parameters = {
        @Parameter(
            name = "postId",
            description = "ID of the post to remove upvote from",
            required = true),
        @Parameter(
            name = "userId",
            description = "ID of the user removing the upvote",
            required = true)
      })
  public ResponseEntity<String> removeUpvoteFromPost(
  ...
  public ResponseEntity<String> upvoteComment(
  ...
  @Operation(
      ...
      parameters = {
        @Parameter(
            name = "commentId",
            description = "ID of the comment to remove upvote from",
            required = true),
        @Parameter(
            name = "userId",
            description = "ID of the user removing the upvote",
  ...
  public ResponseEntity<String> removeUpvoteFromComment(
      @PathVariable Long commentId, @PathVariable Long userId) {
