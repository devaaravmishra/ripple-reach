...
@Tag(
    name = "Community",
    description =
        "The Community API. Contains all the operations that can be performed on a community.")
@AllArgsConstructor
public class CommunityController {
  ...
  @Operation(summary = "Get Community by ID", description = "Retrieves the community by its ID.")
  ...
  @GetMapping
  @Operation(summary = "Retrieves All Communities", description = "Get all communities.")
  public ResponseEntity<Page<CommunityResponse>> getAllCommunities(
    ...
    Page<CommunityResponse> communityResponse = communities.map(communityResponseMapper::mapTo);
  ...
  public ResponseEntity<CommunityResponse> partialUpdateCommunity(
      ...
      @Valid @ModelAttribute CommunityUpdateRequest communityRequestDto) {
  ...
  @SecurityRequirement(name = "Bearer Authentication")
  @Operation(summary = "Delete Community", description = "Deletes an existing community by its ID.")
