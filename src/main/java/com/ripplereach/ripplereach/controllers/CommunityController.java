...
public class CommunityController {
    ...
    public ResponseEntity<CommunityResponseDto> createCommunity
            (@Valid @RequestPart CommunityRequestDto communityRequestDto) {
    ...
    public ResponseEntity<CommunityResponseDto> updateCommunity
            (@PathVariable Long communityId, @Valid @RequestPart CommunityRequestDto communityRequestDto) {
    ...
    public ResponseEntity<CommunityResponseDto> partialUpdateCommunity
            (@PathVariable Long communityId, @Valid @RequestPart CommunityUpdateRequestDto communityRequestDto) {
