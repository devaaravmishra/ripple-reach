...
@Tag(
    name = "Category",
    description =
        "The Category API. Contains all the operations that can be performed on a category.")
@AllArgsConstructor
public class CategoryController {
  ...
  public ResponseEntity<Page<CategoryResponse>> getAllCategories(
    ...
    Page<CategoryResponse> response = categories.map(categoryResponseMapper::mapTo);

    return new ResponseEntity<>(response, HttpStatus.OK);
  }

  @GetMapping("/{categoryId}")
  @Operation(summary = "Get Category by ID", description = "Retrieves the category by its ID.")
  ...
  public ResponseEntity<CategoryResponse> createCategory(
    ...
    Category category =
        categoryService.create(categoryRequest.getName(), categoryRequest.getDescription());
  ...
  public ResponseEntity<CategoryResponse> updateCategory(
    ...
    Category category =
        categoryService.update(
            categoryId, categoryRequest.getName(), categoryRequest.getDescription());
  ...
  public ResponseEntity<CategoryResponse> partialUpdateCategory(
    ...
    Category category =
        categoryService.partialUpdate(
            categoryId, categoryUpdateRequest.getName(), categoryUpdateRequest.getDescription());
