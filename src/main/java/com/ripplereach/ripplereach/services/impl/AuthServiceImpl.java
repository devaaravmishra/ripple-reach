...
public class AuthServiceImpl implements AuthService {
    ...
    public User register(User user) {
       try {
           ...
           Optional<User> existingUser = userRepository.findUserByPhone(oneWayPhoneHex).
           ...
           // Now check whether the user idToken is a valid Firebase IdToken (This means this user is verified)
           //
           //
           ...
           if (user.getCompany() != null) {
               ...
               Optional<University> university = universityRepository
                       .findByName(user.getUniversity().getName());
