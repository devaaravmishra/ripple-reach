...
public class CommentServiceImpl implements CommentService {
  ...
  public CommentResponse createComment(Long postId, Long userId, String content) {
    try {
      ...
      log.info(
          "Comment with commentId: {} is created within post with postId: {} by user with userId:"
              + " {}",
          savedComment.getId(),
          postId,
          userId);
  ...
  public CommentResponse updateComment(Long commentId, CommentUpdateRequest commentUpdateRequest) {
    try {
      ...
      log.info(
          "Comment with commentId: {} within post with postId: {} by user with userId: {} is"
  ...
  public void decrementUpvotes(Long commentId) {
    try {
      ...
      throw new RippleReachException(
          "Unable to remove upvote from the comment with id: " + commentId);
    }
  }
